...
function QuestionList() {
  ...
  const handleViewDetails = (id) => {
    navigate('/questiondetails', { state: { idQuestion: id } });
  };
  ...
  // au lancement du component, on va chercher les questions corresondantes à la page
  useEffect(() => {
    async function GetData() {
      try {
        var response = await axios.get(`http://localhost:8080/api/questions/all_attente`);
